...
const decisionMakers = [
  ...
  },
  {
    ...
    category: "Decision-maker",
    bio: "Mandefro Kebede is a Field Epidemiologist and public health professional serving as the Head of the Surveillance and Disease Intelligence Division at the Ethiopian Public Health Institute (EPHI). He holds a Master of Public Health (MPH) in Field Epidemiology from Addis Ababa University and has extensive experience in public health surveillance, epidemic intelligence, outbreak preparedness and response, and digital health systems. He has led the development and implementation of key national surveillance initiatives, including the rollout of DHIS2 for indicator-based surveillance, the ePHEM digital platform, and other innovative surveillance and data management systems. His work focuses on strengthening early warning systems, disease intelligence, predictive analytics, and evidence-based decision-making to improve public health emergency preparedness and response in Ethiopia. He has also contributed to national and international projects on surveillance, climate-sensitive infectious diseases, and health security, collaborating with partners to advance resilient public health systems.",
